...
<div class="circle" id="circle" style="cursor: pointer; background-color: rgb(0, 0, 230);" onclick="openNav()"></div>
	<div id = "bgimg">
 <div  id="profile">
 <img src = "img.png" style="width:150px;height:150px;  border-radius: 80%; border-style: solid; border-color: blue;"/>
  </div>
<img src="c.jpg" id="src" alt="alt" />
...
<h2 id="h2"> YOUR DETAILS </h2>
<div id="about">
<h2> First Name :    <span> <?php echo $fstname ; ?>  </span> </h2>
<br/>
<br/>
<h2> Last  Name :  <span> <?php echo $lstname; ?>    </span></h2>
<br/>
<br/>
<h2> EMAIL : <span> <?php echo $email; ?>   </span> </h2>
</div>
 <a href ="logout.php"> <img src="logout.png"  style="width: 200px; height:100px; margin-left:600px;"> </a> 
